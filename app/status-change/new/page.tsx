        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6">
            ...
            <div className="space-y-6">
                ...
                <div className="flex gap-3 pb-8">
                    <button onClick={() => selectedClient ? router.push(`/clients/${selectedClient.id}`) : router.back()} className="flex-1 py-3 bg-white border border-gray-300 rounded-xl font-medium text-gray-700" type="button">
                        Cancel
                    </button>
                    <button
